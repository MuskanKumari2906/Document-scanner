  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <header className="max-w-3xl mx-auto pt-12 pb-8 px-6 text-center">
        <div className="inline-block mb-4 p-3 bg-white rounded-full shadow-sm border border-neutral-200">
          <FileText className="w-8 h-8 text-neutral-600" />
        </div>
        <h1 className="text-4xl md:text-5xl font-serif text-neutral-900 mb-4 tracking-tight">
          Let’s figure this document out.
        </h1>
        <p className="text-lg text-neutral-600 font-sans max-w-xl mx-auto leading-relaxed">
          Upload any official letter, bill, or notice. I’ll explain what it means in simple terms.
        </p>
      </header>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 transition-opacity duration-300">
              <label className="block text-lg font-serif font-medium text-neutral-800">
                1. Which document are we looking at?
              </label>
            ...
            {file && (
              <div className="space-y-4 animate-in slide-in-from-bottom-2 fade-in duration-500">
                ...
                <label className="block text-lg font-serif font-medium text-neutral-800">
                  2. Which language do you read best?
                </label>
                <LanguageSelector
                ...
                >
                  {loading ? (
                    ...
                    <>
                      ...
                      <span>Help me understand this</span>
                    </>
                  )}
                </button>
                {error && (
